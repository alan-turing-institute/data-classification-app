...
def insert_initial_policies(policy_group_model_cls, policy_model_cls, policy_assignment_model_cls):
    ...
    mirror_whitelist_policy = insert(
        ...
        description="Package mirrors should include only white-listed " "software.",
    )
    ...
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=tier_0_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=mirror_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=inbound_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=outbound_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=device_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=physical_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=user_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=connection_ssh_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=internet_allowed_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=software_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=ingress_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=copy_allowed_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=ref_class_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=ref_reclass_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ZERO, policy=egress_allowed_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=tier_1_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=mirror_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=inbound_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=outbound_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=device_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=physical_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=user_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=connection_ssh_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=internet_allowed_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=software_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=ingress_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=copy_allowed_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=ref_class_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=ref_reclass_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.ONE, policy=egress_allowed_policy)
    ...
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=connection_rdp_policy)
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=internet_forbidden_policy)
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=software_airlock_policy)
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=ingress_open_policy)
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=copy_restricted_policy)
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=ref_class_required_policy)
    insert(policy_assignment_model_cls, tier=Tier.TWO, policy=ref_reclass_open_policy)
