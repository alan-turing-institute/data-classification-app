...
class ClassificationQuestionQuerySet(models.QuerySet):
    def get_starting_question(self, question_set="turing"):
        return self.get_ordered_questions(question_set=question_set)[0]

    def get_ordered_questions(self, question_set="turing"):
        """
        ...
        ordered = []
        for q in self.filter(hidden=False, question_set__name=question_set):
