# Generated by Django 2.1 on 2019-07-30 15:03
...
def migrate_questions(apps, schema_editor):
    ...
    insert_blank_guidance_if_necessary(apps, 'commercial_data')
    insert_blank_guidance_if_necessary(apps, 'living_individual')
    insert_blank_guidance_if_necessary(apps, 'personal_data')
    insert_blank_guidance_if_necessary(apps, 'pseudonymized_data')
