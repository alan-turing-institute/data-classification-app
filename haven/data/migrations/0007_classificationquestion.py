...
def insert_questions(apps, schema_editor):
    ...
    for k, q in questions.items():
        insert_blank_question_if_necessary(apps, k)
    for k, q in questions.items():
        migrate_question(apps, k, q)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(insert_questions, migrations.RunPython.noop),
    ]
...
PUBLISHABLE = (
    'Could all the data handled or generated by published, '
